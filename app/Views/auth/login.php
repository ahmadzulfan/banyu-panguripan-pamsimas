...
<div class="row h-100">
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            <div class="auth-logo">
                <a href="index.html"><img src="\assets\images\pamsimas.png" alt="Logo" style="width: 75%; max-width: 150px; height: 75%; max-width: 150px"></a>
            </div>
            <h1 class="auth-title">Login </h1>
            <p class="auth-subtitle mb-5">Silahkan Masukan Email dan Password </p>
            ...
            <form action="<?= url_to('login') ?>" method="post" class="needs-validation" novalidate>
                ...
                <?php if ($config->validFields === ['email']): ?>
                    <div class="form-group position-relative has-icon-left mb-4">
                        <input type="email" name="login" class="form-control form-control-xl <?php if (session('errors.login')) : ?>is-invalid<?php endif ?>" placeholder="<?=lang('Auth.email')?>">
